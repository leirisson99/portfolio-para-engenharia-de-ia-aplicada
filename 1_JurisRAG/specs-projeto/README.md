...
| Feature | Status |
|---------|--------|
| F1 Ingestão e Normalização | Não iniciado |
| F2 Estratégia de Chunking | Não iniciado |
| F3 Embeddings e Vector Store | Não iniciado |
| F4 Pipeline RAG | Não iniciado |
| F5 Golden Dataset | Não iniciado |
